...
На основе класса BST, реализованного в задании 1, реализуйте родовой класс крачно-чёрного дерева. Для реализации пронаследуйте тип узла дерева двоичного поиска с добавлением необходимой информации, переопределите/доопределите функционал шаблонных методов для обеспечения выполнения балансировки дерева после выполнения основного алгоритма.
